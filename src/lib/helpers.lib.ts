...
export function sortByDate(a: any, b: any) {
  const A = dayjs(a.frontmatter.date).unix()
  const B = dayjs(b.frontmatter.date).unix()
...
export function sortPostsByDate(array: any): any {
  const sorted: any = [...array]
  return sorted.sort((a: any, b: any) => {
    const A = dayjs(a.frontmatter.date).unix()
    const B = dayjs(b.frontmatter.date).unix()
...
export function sortPostsByDateDesc(array: any): any {
  const sorted: any = [...array]
  return sorted.sort((a: any, b: any) => {
    const A = dayjs(a.frontmatter.date).unix()
    const B = dayjs(b.frontmatter.date).unix()
